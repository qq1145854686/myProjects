...
<body>
	...
	String sqlQuery = "select * from test_data.limit_table";
	...
	while (rs.next()) {
        ...
        String role =  rs.getString("limit_table_role");
        jsonObject.put("role", role);
        String limit =  rs.getString("limit_table_limit");
        jsonObject.put("limit", limit);
        if (role  == null && limit == null) {
            list.add("error");
         } else {
            list.add(jsonObject);
        };
      } 
	  System.out.println("list_limit:"+ list);
	  request.setAttribute("list_limit", list);
	%>
	<table border="1" style="border-collapse:collapse;" >
		...
		<tbody>
		<c:forEach var="item"  items="${list_limit}"  begin="0" end="10"  varStatus="s" >
		 <tr>
